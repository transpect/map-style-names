...
<p:library 
  ...
  <p:declare-step name="consolidate-maps" type="css:consolidate-maps">
    <p:input port="source" primary="true" sequence="true">
      <p:documentation>HTML tables where the first column contains system names
        for styles and the second column contains the corresponding user-defined names.
        A third column may contain comments.
      </p:documentation>
    </p:input>
